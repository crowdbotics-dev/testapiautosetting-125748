...
## Project Structure
    ...
    ├── testapiautosetting_125748  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125748`
...
2. Clone this repo and `cd testapiautosetting_125748`
